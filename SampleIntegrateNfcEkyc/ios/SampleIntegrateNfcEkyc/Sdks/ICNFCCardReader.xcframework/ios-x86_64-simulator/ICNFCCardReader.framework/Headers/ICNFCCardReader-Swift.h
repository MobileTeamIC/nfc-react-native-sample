...
- (void)icNFCReaderChipCompletedWithAvatar:(UIImage * _Nonnull)avatar informationDetails:(NSDictionary<NSString *, NSString *> * _Nonnull)informationDetails dataGroups:(NSDictionary<NSString *, NSString *> * _Nonnull)dataGroups;
@end
...
@property (nonatomic, weak) id <ICNFCReaderChipDelegate> _Nullable delegate;
...
@property (nonatomic, copy) NSArray<NSNumber *> * _Nonnull readingTagsNFC;
- (void)viewDidLoad;
